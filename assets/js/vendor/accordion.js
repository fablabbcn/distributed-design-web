(function ($) {
  ...
  $.fn.beefup = function (options) {
    ...
    this.open = function ($el, callback) {
      ...
      $el.each(function () {
        var $this = $(this)
        var vars = beefup.methods.getVars($this)
        var $content = $this.find(vars.content + ':first')
        var animation = (vars.animation === 'slide') ? 'slideDown'
    ...
    this.close = function ($el, callback) {
      ...
      $el.each(function () {
        ...
        var vars = beefup.methods.getVars($this)
        var $content = $this.find(vars.content + ':first')
        var animation = (vars.animation === 'slide') ? 'slideUp'
    ...
    return this.each(function (index, el) {
      var $el = $(el)
      var vars = $.extend({}, beefup.defaults, options, $el.data('beefup-options'))
