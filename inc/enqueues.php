...
function the_theme_scripts() {
    ...
    wp_enqueue_style(
        'grids',
        get_stylesheet_directory_uri() . '/assets/css/grids.css',
         null, time()
    );
    ...
    // wp_enqueue_script(
    //     'placeholders',
    //     get_stylesheet_directory_uri() . '/assets/js/placeholders.js',
    //     array( 'jquery' ), false, true
    // );
    ...
    wp_register_script( 'theme-scripts', get_template_directory_uri() . '/assets/js/theme-scripts.js', $js_names, false, true);
